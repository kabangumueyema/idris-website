        ...
        <div>
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <a href="mailto:kabangumueyema7@gmail.com" className="min-w-0 break-all text-sm text-blue-700 hover:text-blue-800 hover:underline">kabangumueyema7@gmail.com</a>
            </div>
            <div className="flex items-start gap-3">
              <svg className="mt-0.5 h-5 w-5 shrink-0 text-slate-400" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
              </svg>
              <a href="tel:+243848432439" className="min-w-0 text-sm text-blue-700 hover:text-blue-800 hover:underline">+243 84 843 24 39</a>
            </div>
            <div className="flex items-start gap-3">
              <svg className="mt-0.5 h-5 w-5 shrink-0 text-slate-400" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
